  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "inline-c".revision = (((hackage."inline-c")."0.9.1.6").revisions).default;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "simhash".components.exes."simhash-infer".planned = lib.mkOverride 900 true;
          ...
          "simhash".components.exes."simhash-train".planned = lib.mkOverride 900 true;
          ...
          "simhash".components.library.planned = lib.mkOverride 900 true;
